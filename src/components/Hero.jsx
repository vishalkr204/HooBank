...
const Hero = () => (
  ...
  md:flex-row flex-col ${styles.paddingY}`}>
    ...
    flex-col xl:px-0 sm:px-16 px-6`}>
      ...
      <h1 className=' font-poppins font-semibold ss:text-[72px] text-[68px] text-white
      ss:leading-[100px] leading-[75px] w-full'>
        Payment Method.
      </h1>
      <p className={`${styles.paragraph} max-w-[470px] mt-5`}>
        Our team of experts uses a methodology to identiy the credit 
        cards most likely to fit your needs. We examine annual percentage rates, annual
        fees.
      </p>
