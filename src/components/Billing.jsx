...
const Billing = () => (
   <section id="product" className={layout.sectionImgReverse}>
    ...
    <p className={`${styles.paragraph} max-w-[470px] mt-5`}> 
      Lorem, ipsum dolor sit amet consectetur adipisicing elit. Magnam quisquam officia est autem voluptatibus ipsum vero voluptates doloremque perspiciatis aut asperiores, dignissimos sunt expedita. Quibusdam doloribus officiis tenetur rem dolorum.
    </p>
